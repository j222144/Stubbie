...
<div class="top-bar">
    <div class="top-bar-left">
        <ul class="dropdown menu" data-dropdown-menu>
            <li class="menu-text">Boomarks</li>
            <li><a href="{{route('bookmarks.index')}}">All Bookmarks</a></li>
            <li><a href="{{route('bookmarks.create')}}">Add Bookmark</a></li>
            <li><a href="{{route('bookmarks.create')}}">Link</a></li>
            <li><a href="{{route('bookmarks.create')}}">Link</a></li>
        </ul>
    </div>
</div>
